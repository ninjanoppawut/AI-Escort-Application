...
| AUTH-002–AUTH-004 | PRD §§3–4; D-031, D-047 | Create/edit class, invite code/link/QR, invite preview remain P1-03/P1-04/P1-05 | Class and invitation mutation RPCs remain P1-03/P1-04; P1-02 intentionally exposes no browser writes | `classes`, `class_members`, `class_invites`, constraints, actor-validation triggers, grants, and RLS in `20260805224248_phase1_class_foundation.sql`; token hash excluded from authenticated grants | `phase1_class_foundation_test.sql` (46 assertions) plus `phase1_class_foundation_concurrency.ps1`; atomic invite consumption/idempotency remains P1-04 | P1-02–P1-05 |
| AUTH-005–AUTH-007 | PRD §2; D-030, D-059 | Role homes and class/member-list UI remain P1-05 | Authorized class/member reads; mutation contracts remain later slices | Membership-authoritative class/member/invite RLS and least-privilege grants in `20260805224248_phase1_class_foundation.sql` | Positive/negative, cross-class, inactive/unconfirmed, role-escalation, and non-disclosure pgTAP coverage; Playwright UI coverage remains P1-05/P1-06 | P1-02, P1-05, P1-06 |
