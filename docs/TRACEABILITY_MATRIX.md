...
| GRP-001 | PRD §5; D-035, D-041 | Student group board remains P3-03; schema foundation now available for authoritative groups/current memberships | group-board read model remains P3-03 | `groups`, `group_members`, class-member RLS, and current-group indexes in `20260813050854_phase3_group_foundation.sql` | `phase3_group_foundation_test.sql` covers group/member RLS and current schema invariants; availability and stale-refetch UI remain P3-03/P3-04 | P3-01, P3-03–P3-04 |
