...
import { activateSessionGroup } from "@/features/sessions/server/operations";
...
export async function POST(
  ...
  const body = activateSessionGroupRequestSchema.safeParse(
  ...
  const result = await activateSessionGroup(
