...
import { getSessionLiveLocations } from "@/features/sessions/live-location/server/operations";
...
// Teacher-only named positions; responses are no-store like every route here.
export async function GET(
  ...
  const result = await getSessionLiveLocations(
