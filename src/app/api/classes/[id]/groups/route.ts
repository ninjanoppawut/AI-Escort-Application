...
import { createTeacherGroup } from "@/features/groups/server/teacher";
import { createTeacherGroupRequestSchema } from "@/features/groups/teacher";
...
export async function POST(
  ...
  const body = createTeacherGroupRequestSchema.safeParse(
  ...
  const result = await createTeacherGroup(
