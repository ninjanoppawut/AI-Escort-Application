...
import { TeacherSessionLive } from "@/features/sessions/components/teacher-session-live";
...
export default async function TeacherSessionLivePage({
  ...
  if (identity.error) {
    if (
      ...
      const query = new URLSearchParams({
        ...
        returnTo: `/teacher/classes/${classId}/sessions/${sessionId}/live`,
      });
  ...
  const result = await getSessionLive(
